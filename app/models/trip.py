from sqlalchemy import Column, String, Text, DateTime, Integer, Decimal, JSON, Index, Time, Date
...
class TripPlace(BaseModel):
    ...
    trip_id = Column(Integer, nullable=False, comment="行程ID")
    day_id = Column(Integer, nullable=False, comment="行程日程ID")
    day_index = Column(Integer, nullable=False, comment="第几天")
...
class TripFood(BaseModel):
    ...
    trip_id = Column(Integer, nullable=False, comment="行程ID")
    day_id = Column(Integer, comment="行程日程ID")
...
class TripShare(BaseModel):
    ...
    trip_id = Column(Integer, nullable=False, comment="行程ID")
    user_id = Column(Integer, nullable=False, comment="分享用户ID")
...
class TripReview(BaseModel):
    ...
    trip_id = Column(Integer, nullable=False, comment="行程ID")
    user_id = Column(Integer, nullable=False, comment="评价用户ID")
...
class AIModelCall(BaseModel):
    ...
    trip_id = Column(Integer, comment="关联行程ID")
